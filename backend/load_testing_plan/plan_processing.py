...
def vegeta_attack(req_idx, result_folder):
    rate = str(1)
    # if (req_idx == 10 or req_idx == 11 or req_idx == 12 or req_idx == 13):
    #     rate = str(10)
    return get_shell_script_output_using_communicate(str(req_idx), str(1), rate, 'json', str(100), result_folder)
